...
public class SaveFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        // We do not need to use findViewById for each view.
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        // LinearLayoutManager  排列方式， 也可以是 GridLayoutManager
        ...
        savedNewsAdapter.setItemCallback(new SavedNewsAdapter.ItemCallback() {
            ...
            public void onRemoveFavorite(Article article) {
                // call viewModel.deleteSavedArticle
                // when onRemoveFavorite happens
